...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::post('Producto/generaQr', 'ProductoController@generaQr');
    ...
    Route::post('Producto/actualizarTipoCambio', 'ProductoController@actualizarTipoCambio');
    ...
    Route::get('Cupon/listado_cobros', 'CuponController@listado_cobros');
    ...
    Route::post('Cupon/ajaxBuscaCupon', 'CuponController@ajaxBuscaCupon');
    Route::get('Cupon/masivos', 'CuponController@masivos');
    Route::post('Cupon/guardarmasivo', 'CuponController@guardarmasivo');
    ...
    Route::get('User/eliminaMeta/{metaId}', 'UserController@eliminaMeta');
