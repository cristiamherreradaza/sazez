...
<head>
    ...
    <!-- Theme css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('tienda/css/color10.css') }}" media="screen" id="color">
...
<body>
        ...
        <div class="container">
            <div class="row game-product grid-products">
                ...
                @php
                    ...
                    $precioTienda = App\Precio::where('escala_id', 1)->where('producto_id', $p->id)->first();
                @endphp
                        ...
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="product-page(no-sidebar).html">
                                    @if (!blank($imagenesProducto))
                                        <img src="{{ asset('imagenesProductos')."/".$imagenesProducto->imagen }}" class="img-fluid blur-up lazyload bg-img" alt="" id="imagen_{{ $p->id }}">
                                    @else
                                        <img src="{{ asset('tienda/images/sin_imagen.jpg') }}" class="img-fluid blur-up lazyload bg-img" alt="" id="imagen_{{ $p->id }}">
                                    @endif
                                </a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <a href="javascript:void(0)" title="Add to Wishlist" tabindex="0"><i class="ti-heart"
                                        aria-hidden="true"></i></a>
                                <a href="#" data-toggle="modal" title="Vista" tabindex="0" onclick="vistaRapida('{{ $p->id }}', '{{ $p->nombre }}', '{{ $p->descripcion }}', '{{ $precioTienda->precio }}');"><i class="ti-search" aria-hidden="true"></i></a>
                                <a href="compare.html" title="Compare" tabindex="0"><i class="ti-reload"
                                        aria-hidden="true"></i></a>
                            </div>
                            <div class="add-button" data-toggle="modal" data-target="#addtocart">Adicionar</div>
                        </div>
                        <div class="product-detail">
    ...
    <section class="p-0">
        <div class="full-banner parallax text-center p-right">
            <img src="{{ asset('tienda/images/parallax/28.jpg') }}" alt="" class="bg-img blur-up lazyload">
            <div class="container">
                <div class="row">
                    <div class="col">
            ...
            <div class="row">
                <div class="col">
                    <div class="product-4 game-product product-m no-arrow">
                        ...
                        @forelse ($listadoRecomendados as $p)
                        @php
                            $imagenesProducto = App\ImagenesProducto::where('producto_id', $p->id)->first();
                            $precioTienda = App\Precio::where('escala_id', 1)->where('producto_id', $p->id)->first();
                        @endphp
    ...
    {{-- listado categorias --}}
    <div class="container-fluid category-button">
        <section class="section-b-space">
            <div class="row partition1">
                @forelse ($listadoTipos as $lt)
                    <div class="col"><a href="#" class="btn btn-outline btn-block">{{ $lt->nombre }}</a></div>
                @empty
            ...
            <div class="row">
                ...
                <div class="col-md-4 service-block">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4>24 horas X 7 dias</h4>
                            <p>Servicio en linea</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 service-block">
                ...
                <section class="small-section border-section border-top-0">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="subscribe">
                                <div>
                                    <h4>INSCRIBETE A NUESTRO BOLETIN</h4>
                                    <p>No te pierdas de nuestras ofertas y novedades.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
