...
<head>
    ...
    <!-- Icons -->
    <link rel="stylesheet" type="text/css" href="{{ asset('tienda/css/fontawesome.css') }}">

    <!--Slick slider css-->
    <link rel="stylesheet" type="text/css" href="{{ asset('tienda/css/slick.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('tienda/css/slick-theme.css') }}">

    <!-- Animate icon -->
    <link rel="stylesheet" type="text/css" href="{{ asset('tienda/css/animate.css') }}">

    <!-- Themify icon -->
    <link rel="stylesheet" type="text/css" href="{{ asset('tienda/css/themify-icons.css') }}">

    <!-- Bootstrap css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('tienda/css/bootstrap.css') }}">

    <!-- Theme css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('tienda/css/color19.css') }}" media="screen" id="color">
...
<body>
                                ...
                                <div>
                                    <nav>
                                        ...
                                        <ul class="sm pixelstrap sm-horizontal">
                                            <li>
                                                <div class="mobile-back text-right">Atras<i
                                    ...
                                    <div class="icon-nav d-none d-sm-block">
                                        <ul>
                                            <li class="onhover-div mobile-search">
                                                <div><img src="{{ asset('tienda/images/icon/search.png') }}" onclick="openSearch()"
                                                        class="img-fluid blur-up lazyload" alt=""> <i class="ti-search"
                                                        onclick="openSearch()"></i></div>
                                            </li>
                                            <li class="onhover-div mobile-setting">
                                                <div><img src="{{ asset('tienda/images/icon/setting.png') }}"
                        ...
                        <ul class="header-dropdown">
                            ...
                            <li class="onhover-dropdown mobile-account"> <i class="fa fa-user" aria-hidden="true"></i>
                                ...
                                <ul class="onhover-show-div">
                                    <li><a href="#" data-lng="en">Ingresar</a></li>
                                    <li><a href="#" data-lng="es">Salir</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                                    ...
                                    <nav>
                                        <div onclick="closeNav()">
                                            <div class="sidebar-back text-left"><i class="fa fa-angle-left pr-2"
                                                    aria-hidden="true"></i> Atras</div>
                                        </div>
                                        <ul id="sub-menu" class="sm pixelstrap sm-vertical">
                                            @foreach ($listadoTipos as $lt)
                                                <li> 
                                                    <a href="#">{{ $lt->nombre }}</a>
                                                </li>
                                            @endforeach
    ...
    <!-- Home slider -->
    {{-- tamano de las imagenes es de 1920x560 --}}
    <section class="p-0 layout-7">
        <div class="slide-1 home-slider">
            <div>
                <div class="home text-left">
                    <img src="{{ asset('tienda/images/electronics/8.jpg') }}" alt="" class="bg-img blur-up lazyload">
                    <div class="container-fluid custom-container">
                        <div class="row">
                            <div class="col">
    ...
    <div class="title1 section-t-space">
        <h2 class="title-inner1">BIENVENIDOS</h2>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
{{--                 <div class="product-para">
    ...
    <section class="pt-0 section-b-space ratio_asos">
        <div class="container">
            <div class="row game-product grid-products">
                @forelse ($listadoProductos as $p)
                @php
                    $imagenesProducto = App\ImagenesProducto::where('producto_id', $p->id)->first();
                    print_r($imagenesProducto);
                @endphp
                    <div class="product-box col-xl-2 col-lg-3 col-sm-4 col-6">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="product-page(no-sidebar).html"><img src="{{ asset('tienda/images/sin_imagen.jpg') }}"
                ...
                <div class="product-box col-xl-2 col-lg-3 col-sm-4 col-6">
                    <div class="img-wrapper">
                        <div class="front">
                            <a href="product-page(no-sidebar).html"><img src="{{ asset('tienda/images/marketplace/1.jpg') }}"
                                    class="img-fluid blur-up lazyload bg-img" alt=""></a>
                        </div>
                        <div class="cart-info cart-wrap">
                            <a href="javascript:void(0)" title="Add to Wishlist" tabindex="0"><i class="ti-heart"
                ...
                <div class="product-box col-xl-2 col-lg-3 col-sm-4 col-6">
                    <div class="img-wrapper">
                        ...
                        <div class="front">
                            <a href="product-page(no-sidebar).html"><img src="{{ asset('tienda/images/marketplace/2.jpg') }}"
                                    class="img-fluid blur-up lazyload bg-img" alt=""></a>
                        </div>
                        <div class="cart-info cart-wrap">
                            <a href="javascript:void(0)" title="Add to Wishlist" tabindex="0"><i class="ti-heart"
                ...
                <div class="product-box col-xl-2 col-lg-3 col-sm-4 col-6">
                    <div class="img-wrapper">
                        <div class="front">
                            <a href="product-page(no-sidebar).html"><img src="{{ asset('tienda/images/marketplace/3.jpg') }}"
                                    class="img-fluid blur-up lazyload bg-img" alt=""></a>
                        </div>
                        <div class="cart-info cart-wrap">
                            <a href="javascript:void(0)" title="Add to Wishlist" tabindex="0"><i class="ti-heart"
                ...
                <div class="product-box col-xl-2 col-lg-3 col-sm-4 col-6">
                    <div class="img-wrapper">
                        <div class="lable-block"><span class="lable4">on sale</span></div>
                        <div class="front">
                            <a href="product-page(no-sidebar).html"><img src="{{ asset('tienda/images/marketplace/4.jpg') }}"
                                    class="img-fluid blur-up lazyload bg-img" alt=""></a>
                        </div>
                        <div class="cart-info cart-wrap">
                            <a href="javascript:void(0)" title="Add to Wishlist" tabindex="0"><i class="ti-heart"
                ...
                <div class="product-box col-xl-2 col-lg-3 col-sm-4 col-6">
                    <div class="img-wrapper">
                        <div class="lable-block"><span class="lable4">on sale</span></div>
                        <div class="front">
                            <a href="product-page(no-sidebar).html"><img src="{{ asset('tienda/images/marketplace/5.jpg') }}"
                                    class="img-fluid blur-up lazyload bg-img" alt=""></a>
                        </div>
                        <div class="cart-info cart-wrap">
                            <a href="javascript:void(0)" title="Add to Wishlist" tabindex="0"><i class="ti-heart"
                ...
                <div class="product-box col-xl-2 col-lg-3 col-sm-4 col-6">
                    <div class="img-wrapper">
                        <div class="front">
                            <a href="product-page(no-sidebar).html"><img src="{{ asset('tienda/images/marketplace/6.jpg') }}"
                                    class="img-fluid blur-up lazyload bg-img" alt=""></a>
                        </div>
                        <div class="cart-info cart-wrap">
                            <a href="javascript:void(0)" title="Add to Wishlist" tabindex="0"><i class="ti-heart"
                ...
                <div class="product-box col-xl-2 col-lg-3 col-sm-4 col-6">
                    <div class="img-wrapper">
                        <div class="front">
                            <a href="product-page(no-sidebar).html"><img src="{{ asset('tienda/images/marketplace/7.jpg') }}"
                                    class="img-fluid blur-up lazyload bg-img" alt=""></a>
                        </div>
                        <div class="cart-info cart-wrap">
                            <a href="javascript:void(0)" title="Add to Wishlist" tabindex="0"><i class="ti-heart"
                ...
                <div class="product-box col-xl-2 col-lg-3 col-sm-4 col-6">
                    <div class="img-wrapper">
                        <div class="lable-block"><span class="lable4">on sale</span></div>
                        <div class="front">
                            <a href="product-page(no-sidebar).html"><img src="{{ asset('tienda/images/marketplace/8.jpg') }}"
                                    class="img-fluid blur-up lazyload bg-img" alt=""></a>
                        </div>
                        <div class="cart-info cart-wrap">
                            <a href="javascript:void(0)" title="Add to Wishlist" tabindex="0"><i class="ti-heart"
                ...
                <div class="product-box col-xl-2 col-lg-3 col-sm-4 col-6">
                    <div class="img-wrapper">
                        <div class="front">
                            <a href="product-page(no-sidebar).html"><img src="{{ asset('tienda/images/marketplace/9.jpg') }}"
                                    class="img-fluid blur-up lazyload bg-img" alt=""></a>
                        </div>
                        <div class="cart-info cart-wrap">
                            <a href="javascript:void(0)" title="Add to Wishlist" tabindex="0"><i class="ti-heart"
                ...
                <div class="product-box col-xl-2 col-lg-3 col-sm-4 col-6">
                    <div class="img-wrapper">
                        <div class="lable-block"><span class="lable4">on sale</span></div>
                        <div class="front">
                            <a href="product-page(no-sidebar).html"><img src="{{ asset('tienda/images/marketplace/10.jpg') }}"
                                    class="img-fluid blur-up lazyload bg-img" alt=""></a>
                        </div>
                        <div class="cart-info cart-wrap">
                            <a href="javascript:void(0)" title="Add to Wishlist" tabindex="0"><i class="ti-heart"
                ...
                <div class="product-box col-xl-2 col-lg-3 col-sm-4 col-6">
                    <div class="img-wrapper">
                        <div class="lable-block"><span class="lable4">on sale</span></div>
                        <div class="front">
                            <a href="product-page(no-sidebar).html"><img src="{{ asset('tienda/images/marketplace/11.jpg') }}"
                                    class="img-fluid blur-up lazyload bg-img" alt=""></a>
                        </div>
                        <div class="cart-info cart-wrap">
                            <a href="javascript:void(0)" title="Add to Wishlist" tabindex="0"><i class="ti-heart"
                ...
                <div class="product-box col-xl-2 col-lg-3 col-sm-4 col-6">
                    <div class="img-wrapper">
                        <div class="front">
                            <a href="product-page(no-sidebar).html"><img src="{{ asset('tienda/images/marketplace/12.jpg') }}"
                                    class="img-fluid blur-up lazyload bg-img" alt=""></a>
                        </div>
                        <div class="cart-info cart-wrap">
                            <a href="javascript:void(0)" title="Add to Wishlist" tabindex="0"><i class="ti-heart"
    ...
    <!-- latest jquery-->
    <script src="{{ asset('tienda/js/jquery-3.3.1.min.js') }}"></script>

    <!-- fly cart ui jquery-->
    <script src="{{ asset('tienda/js/jquery-ui.min.js') }}"></script>

    <!-- exitintent jquery-->
    <script src="{{ asset('tienda/js/jquery.exitintent.js') }}"></script>
    <script src="{{ asset('tienda/js/exit.js') }}"></script>

    <!-- popper js-->
    <script src="{{ asset('tienda/js/popper.min.js') }}"></script>

    <!-- slick js-->
    <script src="{{ asset('tienda/js/slick.js') }}"></script>

    <!-- menu js-->
    <script src="{{ asset('tienda/js/menu.js') }}"></script>

    <!-- lazyload js-->
    <script src="{{ asset('tienda/js/lazysizes.min.js') }}"></script>

    <!-- Bootstrap js-->
    <script src="{{ asset('tienda/js/bootstrap.js') }}"></script>

    <!-- Bootstrap Notification js-->
    <script src="{{ asset('tienda/js/bootstrap-notify.min.js') }}"></script>

    <!-- Fly cart js-->
    <script src="{{ asset('tienda/js/fly-cart.js') }}"></script>

    <!-- Theme js-->
    <script src="{{ asset('tienda/js/script.js') }}"></script>
