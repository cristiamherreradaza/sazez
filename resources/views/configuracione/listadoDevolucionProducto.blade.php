...
<div id="modal_tipos" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ url('Configuracione/guardaDevolucionProducto') }}" method="POST" id="formularioConfiguraciones">
                @csrf
...
<script>
    ...
    function eliminar(id, nombre)
    {
        Swal.fire({
            ...
            if (result.value) {
                window.location.href = "{{ url('Configuracione/eliminaMotivoDevolucionProducto') }}/"+id;
                Swal.fire(
                    'Excelente!',
