                    ...
                    @foreach($tipos as $key => $tipo)
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-danger" title="Eliminar tipo"  onclick="eliminar('{{ $tipo->id }}', '{{ $tipo->nombre }}')"><i class="fas fa-trash"></i></button>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
...
<div id="nuevo_tipo" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ url('Tipo/guardar') }}" class="needs-validation" method="POST" novalidate>
                @csrf
...
<div id="editar_tipos" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ url('Tipo/actualizar') }}" class="needs-validation" method="POST" novalidate>
                @csrf
                <div class="modal-body">        
