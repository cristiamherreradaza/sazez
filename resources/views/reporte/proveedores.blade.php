    ...
    <div class="col-md-12">
        <div class="card border-info">
            <div class="card-header bg-info">
                <h4 class="mb-0 text-white">REPORTE DE INGRESOS DE PRODUCTOS POR PROVEEDOR</h4>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-2">
...
<script>
    function buscar()
    {
        ...
        table = $('#tabla-tienda').DataTable( {
            ...
            columns: [
                {data: 'nro_envio', name: 'movimientos.id'},
                {data: 'tienda', name: 'almacenes.nombre'},
                {data: 'proveedor_nombre', name: 'proveedores.nombre'},
