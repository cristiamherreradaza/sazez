...
<div id="page-wrap">
	...
	<div id="fh5co-hero-wrapper">
		<nav class="container navbar navbar-expand-lg main-navbar-nav navbar-light">
			<a class="navbar-brand" href="">Sazez</a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav nav-items-center ml-auto mr-auto">
					<li class="nav-item active">
						<a class="nav-link" href="javascript:void(0)">Accesorios <span class="sr-only">(current)</span></a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="javascript:void(0)" onclick="$('#fh5co-features').goTo();return false;">Pedidos</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="javascript:void(0)" onclick="$('#fh5co-reviews').goTo();return false;">Combos</a>
					</li>
					<li class="nav-item">
		...
		<div class="container fh5co-hero-inner">
			<h1 class="animated fadeIn wow" data-wow-delay="0.4s">Bienvenido a nuestra Tienda</h1>
			<p class="animated fadeIn wow" data-wow-delay="0.67s">Grandes ofertas en tecnologia </p>
			<button class="btn btn-md download-btn-first wow fadeInLeft animated" data-wow-delay="0.85s" onclick="$('#fh5co-download').goTo();return false;">Ver Productos</button>
			...
			<img class="fh5co-hero-smartphone animated fadeInRight wow" data-wow-delay="1s" src="{{ asset('assets/app/img/phone-image.png') }}" alt="Smartphone">
		</div>
	...
	<footer class="footer-outer">
		<div class="container footer-inner">
			...
			<div class="footer-three-grid wow fadeIn animated" data-wow-delay="0.66s">
				...
				<div class="column-2-3">
					<nav class="footer-nav">
						<ul>
							<a href="#" onclick="$('#fh5co-hero-wrapper').goTo();return false;"><li>Accesorios</li></a>
							<a href="#" onclick="$('#fh5co-features').goTo();return false;"><li>Pedidos</li></a>
							<a href="#" onclick="$('#fh5co-reviews').goTo();return false;"><li>Combos</li></a>
							<a href="#" onclick="$('#fh5co-download').goTo();return false;"><li class="active">Contactanos</li></a>
						</ul>
					</nav>
				</div>
			...
			<p class="copyright">&copy; {{ date('Y') }} Sazez.net Todos los derechos reservados.</p>
	...
	<script src="{{ asset('assets/app/js/owl.carousel.js') }}"></script>
